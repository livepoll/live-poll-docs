# Use Case Specification: Fill out item details

## Table of contents
1. [Create new poll](#1-fill-out-item-details)
...
## 1. Fill out item details
### 1.1 Brief Description
In this use case the user enters the details for a poll item.
### 1.2 Mockup
